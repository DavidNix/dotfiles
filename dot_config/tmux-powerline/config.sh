...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/gv/8y8kgtw10_37gt24l8br4nvc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/davidnix/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/davidnix/.mailcheckrc"
# }
